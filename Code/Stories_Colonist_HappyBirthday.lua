	...
	if not Sent[Key1]
	 ...
	 then
		...
		AddSocialStory({
			...
			story = T{9013659, "     Today marks yet another milestone in Martian colonization: Today we celebrate a special Martianborn birthday! Indeed, with <MTBirthdayName>'s birthday today we are reminded that this Red Planet is indeed ours! Let this serve as a sign that the Red Planet has truly become the realm of man! It is time to sing, cheer and celebrate at this wonderful news! Happy Birthday <MTBirthdayName>. May your life be long and prosperous.", MTBirthdayName = Name},
		})
	end
end
